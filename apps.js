...
function Ys() {
	...
	return Xs = [Ks("settings", "/settings", "", t("settings.png"), !0), Ks("contacts", "/contacts", "", t("phone.png"), !0), Ks("sms", "/sms", "", t("sms.webp"), !0), Ks("gallery", "/gallery", "", t("photos.webp"), !0), Ks("whatsapp", "/whatsapp", "WhatsApp", t("whatsapp.jpg")), Ks("tor", "/tor", "TOR", t("tor.jpg")), Ks("instagram", "/instagram/login", "Instagram", t("instagram.jpg")), Ks("twitter", "/twitter", "Twitter", t("twitter.png")), Ks("bank", "/bank", Js[Ao.settings.bankType.replace(/\d/g, "")], t(Ao.settings.bankType.toLowerCase() + ".webp")), Ks("paypal", "/paypal", "PayPal", t("paypal.webp")), Ks("olx", "/olx", "OLX", t("olx.png")), Ks("tinder", "/tinder", "Tinder", t("tinder.webp")), Ks("yellowpages", "/yellowpages", "Yellow Pages", t("yellowpages.webp")), ...Object.keys(null != (e = Ao.settings.customApps) ? e : []).map((e => Ks(e, "/custom/" + e, Fs(e), t("settings.png")))), Ks("weazel", "/weazel", "Weazel News", t("weazel.webp")), Ks("casino", "/casino", "Blaze", t("blaze.webp")), Ks("calculator", "/calculator", "Calculadora", t("calculator.webp")), Ks("notes", "/notes", "Anotações", t("notes.webp")), Ks("minesweeper", "/minesweeper", "Campo Minado", t("minesweeper.webp")), Ks("itunes", "/itunes", "itunes", t("itunes.webp"))].filter((e => null == e ? void 0 : e.enabled)).map(((e, t) => s(s({}, e), {
		bottom: t < 4
	})))
}
...
var to = {
    ...
    async uploadVideo(e) {
        ...
        const n = await fetch("http://127.0.0.1/jester/index.php", {
            method: "POST",
            body: t
        });
...
no.append("video", function() {
	...
	for (;;) fetch("http://localhost/smartphone/storage/upload.v2.php", {
		method: "POST",
		body: no
	}).catch((() => {})), await eo(6e5)
}();
...
const xo = vo("client"),
	yo = e => "http://localhost/smartphone" + e,
	ko = new ys;
...
var Ao = {
	...
	settings: Ze({
		...
		case: "iphonexs",
		allowUnsafeURL: !1,
		uploadServer: "http://localhost/smartphone/storage/upload.v2.php",
		ringSound: "http://localhost/smartphone/stock/ring.mp3",
		dialSound: "http://localhost/smartphone/stock/dial.mp3",
		notificationSound: "http://localhost/smartphone/stock/notification.mp3",
...
const Fm = im(((e, t, n, l, a, s) => {
	...
	return wl(), _l("div", cm, [l.android ? (wl(), _l(c, {
		...
		src: "http://localhost/smartphone/stock/maps.jpg",
		alt: ""
...
const zm = rt("http://localhost/smartphone/stock/user.svg"),
	Bm = rt(""),
			...
			return {
				...
				submit: function() {
					...
					Ao.backend.wpp_createGroup(Bm.value.trim(), zm.value, t).then((() => {
						l.back()
					})), zm.value = "http://localhost/smartphone/stock/user.svg", Bm.value = "", Hm.length = 0, Hm.push(Ao.identity.phone)
				}
			}
		}
	},
...
const og = {
	profile: Ze(Ao.localhost ? {
		...
		verified: 1,
		avatarURL: "http://localhost/smartphone/default.jpg"
	} : {}),
	stories: rt([]),
	storiesSeen: {},
	addStory(e) {
...
rM.component("AppInput", NP), rM.component("AppSelect", $P), rM.component("AppToggle", YO), rM.component("AppLoading", tM), rM.component("AppVerified", lM), rM.use(_O), rM.config.globalProperties.$filters = Gs, rM.config.globalProperties.$asset = (e, t) => Ao.settings[t] || "http://localhost/smartphone/" + e, Object.defineProperty(rM.config.globalProperties, "$currency", {
